export const ui = {
  page: "min-h-[calc(100vh-0px)] bg-base-light",
  ...
  inset:
    "bg-white/60 backdrop-blur border border-black/5 rounded-2xl",
  ...
  primaryBtn:
    "rounded-full bg-clemson text-white font-semibold shadow-sm hover:brightness-95 active:scale-[0.98] transition will-change-transform",
  ghostBtn:
    "rounded-full bg-white/70 border border-black/10 text-black/80 font-semibold hover:bg-white active:scale-[0.98] transition will-change-transform",
  dangerBtn:
    "rounded-full bg-rose-500 text-white font-semibold shadow-sm hover:brightness-95 active:scale-[0.98] transition will-change-transform",
